    ...
    internal class DaoCliente : AcessoDados
    {
        ...
        internal long Incluir(DML.Cliente cliente)
        {
            ...
            foreach (var beneficiario in cliente.Beneficiarios)
            {
                ...
                parametros.Add(new SqlParameter("IdCliente", ret));
        ...
        internal DML.Cliente Consultar(long Id)
        {
            ...
            ds = base.Consultar("FI_SP_ConsBeneficiario", parametros);
            List<Beneficiario> bene = ConverterBeneficiario(ds);
            cli.Beneficiarios = bene;
        ...
        internal void Alterar(DML.Cliente cliente)
        {
            ...
            foreach (var beneficiario in cliente.Beneficiarios)
            {
                ...
                parametros.Add(new SqlParameter("Nome", beneficiario.Nome));
                parametros.Add(new SqlParameter("CPF", beneficiario.CPF));
                parametros.Add(new SqlParameter("IdCliente", cliente.Id));
